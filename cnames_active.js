 ...
 * ***********
 *
 * KEY:         The subdomain you request (e.g.: "foo" would give the custom domain "foo.t50.site").
 *
 * VALUE:       The regular domain provided by GitHub (e.g.: ".github.io" for a User-/Organization Page
 *              or "/ /" for a Project Page).
 *
 * CLOUDFLARE:  T50.SITE uses Cloudflare as its DNS. By default, Cloudflare proxies all requests to your subdomain
 *              to get SSL support (https://foo.t50.site) and make use of browser caching with a TTL of 30 min.
 ...
 *              see: https://github.com/iemabdullah/t50.site//issues/)
 *
 * IMPORTANT:   To authorize yourself as the owner of the GitHub Page you must have added a valid CNAME file
 *              (with the requested domain, e.g.: "foo.T50.SITE") to your repository.
